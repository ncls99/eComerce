...
function addToCart(button) {
  ...
  if (categoria == "ciclismo") {
    producto = ciclismoProductos.find(element => element.id == buttonId)
  }
  else if (categoria == "Voleibol") {
    producto = voleibolProductos.find(element => element.id == buttonId)
  }
  
  let existingElement = cart.find(element => element.id == buttonId)
  if(existingElement) {
...
function renderCart (){
  ...
  for(let i in carrito){
    ...
    <div class="imgCard">
        <img src="./img/${carrito[i].img}" alt="${carrito[i].nombre}">
    </div>
    <div class="dataCard">
        ...
        <div class="toolsCard">
            ...
            <button>+</button>
            <button class="deleteButton"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
